...
(function () {
  ...
  const funPopups = [
    {
      ...
      message:
        "Nice! You're checking out our modules. Keep scrolling to discover more awesome SAP training options!",
      shown: false,
    },
    {
      trigger: 50,
      ...
      title: "Halfway There!",
      message:
        "You're really interested! We love it! 💕 Don't miss our special packages below.",
      shown: false,
    },
    {
      trigger: 75,
      ...
      title: "Almost Done!",
      message:
        "You're almost at the bottom! Have you found what you're looking for? Try our chatbot if you have questions!",
      shown: false,
    },
    {
      trigger: 90,
      ...
      title: "You Made It!",
      message:
        "Wow! You scrolled through everything! Ready to start your SAP learning journey? Let's connect! 🚀",
      shown: false,
    },
  ];
  ...
  const initChatbot = () => {
    ...
    setTimeout(() => {
      addMessage(
        "Hi there! 👋 I'm your SAP Learning Assistant. How can I help you today?",
      );
      setTimeout(() => {
        showMainMenu();
      }, 1500);
